...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextView = (TextView) findViewById(R.id.textViewPlace);

        mPredictTextView = (AutoCompleteTextView) findViewById(R.id.textViewFind);
        ...
        // By default, the app will guess the current location
        guessCurrentPlace();
    }
    ...
    /**
     * Use Google's place detection API to guess where the user currently is, and the likelihood of being the user actually being there
     */
        ...
        result.setResultCallback(new ResultCallback<PlaceLikelihoodBuffer>() {
            ...
            public void onResult(PlaceLikelihoodBuffer likelyPlaces) {
                ...
                if (placeLikelihood != null)
                    content += "Chance of being there: " + (int) (placeLikelihood.getLikelihood() * 100) + "%";
    ...
    /**
     * Display the place picker to allow the user to pick a location from a list of nearby places
     */
    ...
    /**
     * Display details of a place selected by the user
     */
